export const m = {
  ...
  Self_Test_Input: '输入',
  Self_Test_Output: '输出',
  Self_Test_Output_Hint: '点击「自测」按钮查看输出',
  Submit_Time: '提交时间',
  Test_Case_Details: '评测详情',
  Test_Case: '测试点',
  Failed_Test_Cases: '失败测试点详情',
  ...
  Drop_Or_Click: '拖拽到此处，或点击手动选择',
  Upload_Avatar: '上传头像',
  Avatar_Will_Be: '您的头像将被设置为：',
  Upload: '上传',
  File_Type_Not_Support: '不支持的文件类型',
  Exceed_Max_Size: '超过最大文件大小限制',
  Discard_Changes: '确定放弃更改吗？',
  Set_New_Avatar_Success: '头像设置成功',
  Real_Name: '真实姓名',
  School: '学校',
  Major: '专业',
  Mood: '心情',
  ...
  Succeeded: '成功',
  Real_Time: '真实时间',
  Real_Time_Limit_Exceeded: '真实时间超限',
  Signal: '信号',
  // SubmissionList.vue
  When: '时间',
  ID: 'ID',
  ...
  Copy: '复制',
  Code: '代码',
  Copy_To_Problem: '复制到题目',
  Copied_To_Problem: '代码已复制到题目编辑器',
  Run_Time: '运行时间',
  Memory_Usage: '内存使用',
  Program_Output: '程序输出',
  ...
  Run_Success: '运行成功',
  CPU_Timeout: 'CPU超时',
  CPU_Time_Limit_Exceeded: 'CPU时间超限',
  ...
  Your_Code: '你的代码',
  // ForumList.vue
  Forum_Category_Nav: '版块导航',
  Forum_All: '全部',
  Forum_Title: '社区',
  Forum_Posts_Count: '{n} 条动态',
  Forum_Search: '搜索...',
  Forum_New_Post: '发动态',
  Forum_Muted: '禁言',
  Forum_Mute_Remain: ' (剩余{n})',
  Forum_Filter_Mine: '我发布的',
  Forum_Filter_Bookmark: '已收藏',
  Forum_Filter_Clear: '清空筛选',
  Forum_Empty: '暂无动态',
  Forum_Unknown_User: '未知',
  Forum_Edit: '编辑',
  Forum_Delete: '删除',
  Forum_Comment_Count: '回复 {n}',
  Forum_Report: '举报',
  Forum_No_Replies: '暂无回复',
  Forum_Reply: '回复',
  Forum_Reply_To: '回复',
  Forum_Cancel: '取消',
  Forum_Reply_Placeholder: '写下你的回复...',
  Forum_Category: '版块',
  Forum_Select_Category: '选择版块',
  Forum_Title_Label: '标题',
  Forum_Title_Placeholder: '标题（可选）',
  Forum_Content: '内容',
  Forum_Publish: '发布',
  Forum_Submit: '提交',
  Forum_Report_Type: '举报类型',
  Forum_Report_Spam: '垃圾信息',
  Forum_Report_Attack: '人身攻击',
  Forum_Report_Ad: '广告推广',
  Forum_Report_Illegal: '违规内容',
  Forum_Report_Other: '其他',
  Forum_Report_Detail_Label: '补充说明',
  Forum_Optional: '选填',
  Forum_Image_Preview: '图片预览',
  Forum_Content_Required: '请输入内容',
  Forum_Edit_Success: '修改成功',
  Forum_Category_Required: '请选择版块',
  Forum_Publish_Success: '发布成功',
  Forum_Delete_Confirm_Title: '确认删除',
  Forum_Delete_Confirm_Content: '删除后无法恢复',
  Forum_Deleted: '已删除',
  Forum_Reply_Success: '回复成功',
  Forum_Report_Submitted: '举报已提交'
}
