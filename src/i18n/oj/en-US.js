export const m = {
  ...
  Self_Test_Output_Hint: 'Click "Self Test" to see output',
  Submit_Time: 'Submit Time',
  Test_Case_Details: 'Test Case Details',
  Test_Case: 'Test Case',
  Failed_Test_Cases: 'Failed Test Cases',
  ...
  Avatar_Setting: 'Avatar Setting',
   ...
   Drop_Or_Click: 'Drop here, or click to select manually',
   Upload_Avatar: 'Upload Avatar',
   Avatar_Will_Be: 'Your avatar will be set to:',
   Upload: 'Upload',
   File_Type_Not_Support: 'File type not support',
   Exceed_Max_Size: 'Exceed max size limit',
   Discard_Changes: 'Are you sure to discard the changes?',
   Set_New_Avatar_Success: 'Successfully set new avatar',
   Real_Name: 'Real Name',
   School: 'School',
   Major: 'Major',
   Mood: 'Mood',
  ...
  No_Recommendations_Immersion: 'No recommendations yet, please solve some problems first!',
  Immersion_Loading: 'Picking problems for you...',
  ...
  Copy: 'Copy',
  Code: 'Code',
  Copy_To_Problem: 'Copy to Problem',
  Copied_To_Problem: 'Code copied to problem editor',
  Run_Time: 'Run Time',
  ...
  'Lesson_Plan_Management': 'Lesson Plan Management',
  // ForumList.vue
  Forum_Category_Nav: 'Categories',
  Forum_All: 'All',
  Forum_Title: 'Community',
  Forum_Posts_Count: '{n} Posts',
  Forum_Search: 'Search...',
  Forum_New_Post: 'New Post',
  Forum_Muted: 'Muted',
  Forum_Mute_Remain: ' ({n} remaining)',
  Forum_Filter_Mine: 'My Posts',
  Forum_Filter_Bookmark: 'Bookmarked',
  Forum_Filter_Clear: 'Clear Filters',
  Forum_Empty: 'No posts yet',
  Forum_Unknown_User: 'Unknown',
  Forum_Edit: 'Edit',
  Forum_Delete: 'Delete',
  Forum_Comment_Count: '{n} Replies',
  Forum_Report: 'Report',
  ...
  Forum_Select_Category: 'Select a category',
  Forum_Title_Label: 'Title',
  Forum_Title_Placeholder: 'Title (optional)',
  Forum_Content: 'Content',
  Forum_Publish: 'Publish',
  Forum_Submit: 'Submit',
  Forum_Report_Type: 'Report Type',
  Forum_Report_Spam: 'Spam',
  Forum_Report_Attack: 'Personal Attacks',
  Forum_Report_Ad: 'Advertising',
  Forum_Report_Illegal: 'Inappropriate Content',
  Forum_Report_Other: 'Other',
  Forum_Report_Detail_Label: 'Details',
  Forum_Optional: 'Optional',
  Forum_Image_Preview: 'Image Preview',
  Forum_Content_Required: 'Please enter some content',
  Forum_Edit_Success: 'Updated successfully',
  Forum_Category_Required: 'Please select a category',
  Forum_Publish_Success: 'Posted successfully',
  Forum_Delete_Confirm_Title: 'Confirm Deletion',
  Forum_Delete_Confirm_Content: 'This action cannot be undone',
  Forum_Deleted: 'Deleted',
  Forum_Reply_Success: 'Reply posted successfully',
  Forum_Report_Submitted: 'Report submitted'
}
