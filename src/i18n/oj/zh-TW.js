export const m = {
  ...
  Self_Test: '自測',
  Self_Test_Placeholder: '輸入測試資料...',
  Self_Test_Run: '運行測試',
  Self_Test_Result: '測試結果',
  Self_Test_Input: '輸入',
  Self_Test_Output: '輸出',
  Self_Test_Output_Hint: '點擊「自測」按鈕查看輸出',
  Submit_Time: '提交時間',
  Test_Case_Details: '評測詳情',
  Test_Case: '測試點',
  Failed_Test_Cases: '失敗測試點詳情',
  ...
  Drop_Or_Click: '拖曳到此處，或點擊手動選擇',
  Upload_Avatar: '上傳大頭貼',
  Avatar_Will_Be: '您的大頭貼將被設定為：',
  Upload: '上傳',
  File_Type_Not_Support: '不支援的檔案類型',
  Exceed_Max_Size: '超過最大檔案大小限制',
  Discard_Changes: '確定放棄變更嗎？',
  Set_New_Avatar_Success: '大頭貼設定成功',
  Real_Name: '真實姓名',
  School: '學校',
  Major: '專業',
  Mood: '心情',
  ...
  Succeeded: '成功',
  Real_Time: '真實時間',
  Real_Time_Limit_Exceeded: '真實時間超限',
  Signal: '訊號',
  // SubmissionList.vue
  When: '時間',
  ID: 'ID',
  ...
  No_Recommendations_Immersion: '暫無推薦題目，請先做一些題目吧！',
  Immersion_Loading: '正在為你挑選題目...',
  ...
  Copy: '複製',
  Code: '代碼',
  Copy_To_Problem: '複製到題目',
  Copied_To_Problem: '代碼已複製到題目編輯器',
  Run_Time: '運行時間',
  Memory_Usage: '內存使用',
  Program_Output: '程序輸出',
  ...
  Feature_Knowledge_Universe: '知識宇宙',
  Feature_Knowledge_Universe_Desc: '可縮放、可探索的知識星圖，點選任意知識點進入沉浸式學習艙',
  ...
  Run_Success: '運行成功',
  CPU_Timeout: 'CPU超時',
  CPU_Time_Limit_Exceeded: 'CPU時間超限',
